from models.multi_objective_models import MORSpyMaster, MORSpyMPNet, MORSpyMiniLM
...
@torch.no_grad()
def test_loop(model: MORSpyMaster, dataloader: DataLoader, device: torch.device, verbose=False, use_model_out=False, pos_split=6, neg_split=4, neut_split=5):
...
if __name__ == "__main__":
    ...
    parser.add_argument('-m', type=str, help='Model Path', default=BASE_DIR + "model_data/static_board_mpnet/model.pth")
